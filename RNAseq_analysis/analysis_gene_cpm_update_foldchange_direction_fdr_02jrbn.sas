...
data fdr_w_sign_&fdrsuffix.;
  ...
  else if flag_gene_on_01gy_3hr_cpm0 ne 1 and flag_gene_on_Mock_3hr_cpm0=1 then sign_01gy_v_Mock_3h_&fdrsuffix.="Mock";
  ...
  if flag_gene_on_1gy_72hr_cpm0=1 and flag_gene_on_Mock_72hr_cpm0=1 then do;
...
if flag_gene_on_1gy_24hr_cpm0=1 and flag_gene_on_mock_24hr_cpm0=1 then flag_gene_1gy_v_Mock_24h_dd=0;
else if flag_gene_on_1gy_24hr_cpm0=1 or flag_gene_on_mock_24hr_cpm0=1 then flag_gene_1gy_v_Mock_24h_dd=1;
...
data  rs.arab_sign_by_cntrst_gene_cpm_fdr;
  set fdr_w_sign2;
run;

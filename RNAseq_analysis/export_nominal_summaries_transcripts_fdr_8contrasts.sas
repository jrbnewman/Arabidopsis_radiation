...
data gene_coord2;
  merge xs_info (in=in1) symbol2gene (in=in2);
  by gene_id;
  if in1 ;
...
data lsmeans;
  set rs.arab_xs_cntrs_lsmeans_non;
  ...
  keep transcript_id group estimate;
run;

proc sort data=lsmeans;
   by transcript_id group;
...
data estimates;
  set rs.arab_xs_cntrs_estim_non;
  length est_label $32.;
  ...
  keep transcript_id est_label estimate;
run;

proc sort data=estimates;
   by transcript_id est_label;
...
data flag_dtct;
   ...
   keep transcript_id    flag_xscript_on_01gy_apn0    flag_xscript_on_1gy_apn0
   flag_xscript_on_Mock_apn0    flag_xscript_on_1hr_tpm0   flag_xscript_on_3hr_tpm0
   flag_xscript_on_24hr_tpm0   flag_xscript_on_72hr_tpm0   flag_xscript_on_01gy_1hr_tpm0
   flag_xscript_on_01gy_3hr_tpm0   flag_xscript_on_01gy_24hr_tpm0
   flag_xscript_on_01gy_72hr_tpm0   flag_xscript_on_1gy_1hr_tpm0
   flag_xscript_on_1gy_3hr_tpm0   flag_xscript_on_1gy_24hr_tpm0
   flag_xscript_on_1gy_72hr_tpm0   flag_xscript_on_Mock_1hr_tpm0
   flag_xscript_on_Mock_3hr_tpm0   flag_xscript_on_Mock_24hr_tpm0
   flag_xscript_on_Mock_72hr_tpm0;

   rename flag_xscript_on_01gy_apn0=flag_01gy_on
   flag_xscript_on_1gy_apn0=flag_1gy_on
   flag_xscript_on_Mock_apn0=flag_Mock_on
   flag_xscript_on_1hr_tpm0=flag_1hr_on
   flag_xscript_on_3hr_tpm0=flag_3hr_on
   flag_xscript_on_24hr_tpm0=flag_24hr_on
   flag_xscript_on_72hr_tpm0=flag_72gy_on
   flag_xscript_on_01gy_1hr_tpm0=flag_01gy_1hr_on
   flag_xscript_on_01gy_3hr_tpm0=flag_01gy_3hr_on
   flag_xscript_on_01gy_24hr_tpm0=flag_01gy_24hr_on
   flag_xscript_on_01gy_72hr_tpm0=flag_01gy_72hr_on
   flag_xscript_on_1gy_1hr_tpm0=flag_1gy_1hr_on
   flag_xscript_on_1gy_3hr_tpm0=flag_1gy_3hr_on
   flag_xscript_on_1gy_24hr_tpm0=flag_1gy_24hr_on
   flag_xscript_on_1gy_72hr_tpm0=flag_1gy_72hr_on
   flag_xscript_on_Mock_1hr_tpm0=flag_Mock_1hr_on
   flag_xscript_on_Mock_3hr_tpm0=flag_Mock_3hr_on
   flag_xscript_on_Mock_24hr_tpm0=flag_Mock_24hr_on
   flag_xscript_on_Mock_72hr_tpm0=flag_Mock_72hr_on;
...
data means;
  set rs.arab_xs_mean_tpm_by_trt_time;
run;
...
data sign;
  set rs.arab_sign_by_contrast_xs_fdr;
  drop flag_xscript_on_: ;
run;
...
data gene_summary gene_skipped;
   length transcript_id $200.;
   format transcript_id $200.;
   informat transcript_id $200.;
...
data gene_summary2;
  set gene_summary;
      if fdr_01gy_v_Mock_1h ne . then log2_fc_01gy_v_Mock_lh=log2(mean_q3tpm_01gy_1h/mean_q3tpm_Mock_1h);
      if fdr_01gy_v_Mock_3h ne . then log2_fc_01gy_v_Mock_3h=log2(mean_q3tpm_01gy_3h/mean_q3tpm_Mock_3h);
      if fdr_01gy_v_Mock_24h ne . then log2_fc_01gy_v_Mock_24h=log2(mean_q3tpm_01gy_24h/mean_q3tpm_Mock_24h);
      if fdr_01gy_v_Mock_72h ne . then log2_fc_01gy_v_Mock_72h=log2(mean_q3tpm_01gy_72h/mean_q3tpm_Mock_72h);

      if fdr_1gy_v_Mock_1h ne . then log2_fc_1gy_v_Mock_lh=log2(mean_q3tpm_1gy_1h/mean_q3tpm_Mock_1h);
      if fdr_1gy_v_Mock_3h ne . then log2_fc_1gy_v_Mock_3h=log2(mean_q3tpm_1gy_3h/mean_q3tpm_Mock_3h);
      if fdr_1gy_v_Mock_24h ne . then log2_fc_1gy_v_Mock_24h=log2(mean_q3tpm_1gy_24h/mean_q3tpm_Mock_24h);
      if fdr_1gy_v_Mock_72h ne . then log2_fc_1gy_v_Mock_72h=log2(mean_q3tpm_1gy_72h/mean_q3tpm_Mock_72h);
run;
...
mean_q3tpm_mock_1h mean_q3tpm_mock_3h mean_q3tpm_mock_24h mean_q3tpm_mock_72h
mean_q3tpm_01gy_1h mean_q3tpm_01gy_3h mean_q3tpm_01gy_24h mean_q3tpm_01gy_72h 
mean_q3tpm_1gy_1h mean_q3tpm_1gy_3h mean_q3tpm_1gy_24h mean_q3tpm_1gy_72h
...
flag_xscript_01gy_v_Mock_1h_dd
...
flag_xscript_01gy_v_Mock_3h_dd
...
flag_xscript_01gy_v_Mock_24h_dd
...
flag_xscript_01gy_v_Mock_72h_dd
...
flag_xscript_1gy_v_Mock_24h_dd
...
flag_xscript_1gy_v_Mock_72h_dd
...
;
 ...
 mean_q3tpm_mock_1h=mean_norm_tpm_mock_1h
 mean_q3tpm_mock_3h=mean_norm_tpm_mock_3h
 mean_q3tpm_mock_24h=mean_norm_tpm_mock_24h
 mean_q3tpm_mock_72h=mean_norm_tpm_mock_72h
 mean_q3tpm_01gy_1h=mean_norm_tpm_01gy_1h
 mean_q3tpm_01gy_3h=mean_norm_tpm_01gy_3h
 mean_q3tpm_01gy_24h=mean_norm_tpm_01gy_24h
 mean_q3tpm_01gy_72h =mean_norm_tpm_01gy_72h
 mean_q3tpm_1gy_1h=mean_norm_tpm_1gy_1h
 mean_q3tpm_1gy_3h=mean_norm_tpm_1gy_3h
 mean_q3tpm_1gy_24h=mean_norm_tpm_1gy_24h
 mean_q3tpm_1gy_72h=mean_norm_tpm_1gy_72h
 ;
...
data fdr05_reduced;
  ...
  keep gene_id symbol transcript_id log2_fc_01gy_v_Mock_lh fdr_01gy_v_Mock_1h flag_01gy_v_Mock_1h_fdr05 sign_01gy_v_Mock_1h_fdr05
                      ...
                      flag_xscript_01gy_v_Mock_1h_dd flag_xscript_01gy_v_Mock_3h_dd flag_xscript_01gy_v_Mock_24h_dd
                      flag_xscript_01gy_v_Mock_72h_dd
                      flag_xscript_1gy_v_Mock_1h_dd flag_xscript_1gy_v_Mock_3h_dd flag_xscript_1gy_v_Mock_24h_dd
                      flag_xscript_1gy_v_Mock_72h_dd
;
run;
...
data fdr10_reduced;
  set gene_summary3;
  where p_treatment ne . ;
  keep gene_id symbol transcript_id log2_fc_01gy_v_Mock_lh fdr_01gy_v_Mock_1h flag_01gy_v_Mock_1h_fdr10 sign_01gy_v_Mock_1h_fdr10
...
data fdr20_reduced;
  set gene_summary3;
  where p_treatment ne . ;
  keep gene_id symbol transcript_id log2_fc_01gy_v_Mock_lh fdr_01gy_v_Mock_1h flag_01gy_v_Mock_1h_fdr20 sign_01gy_v_Mock_1h_fdr20
...
proc export data=fdr05_full outfile="!PATCON/arabidopsis/analysis_output/arab_rs_transcripts_tair10_fdr05_full_results.csv"
dbms=csv replace;
run;
proc export data=fdr05_reduced outfile="!PATCON/arabidopsis/analysis_output/arab_rs_transcripts_tair10_fdr05_simple_results.csv"
dbms=csv replace;
run;


proc export data=fdr10_full outfile="!PATCON/arabidopsis/analysis_output/arab_rs_transcripts_tair10_fdr10_full_results.csv"
dbms=csv replace;
run;
proc export data=fdr10_reduced outfile="!PATCON/arabidopsis/analysis_output/arab_rs_transcripts_tair10_fdr10_simple_results.csv"
dbms=csv replace;
run;


proc export data=fdr20_full outfile="!PATCON/arabidopsis/analysis_output/arab_rs_transcripts_tair10_fdr20_full_results.csv"
dbms=csv replace;
run;
proc export data=fdr20_reduced outfile="!PATCON/arabidopsis/analysis_output/arab_rs_transcripts_tair10_fdr20_simple_results.csv"
dbms=csv replace;
run;

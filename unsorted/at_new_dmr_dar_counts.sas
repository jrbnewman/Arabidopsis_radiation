...
data gene_list;
  ...
  if in1 or in2 then CG_01=1; else CG_01=0;
  if in3 or in4 then CG_1=1; else CG_1=0;
  if in5 or in6 then CHG_01=1; else CHG_01=0;
  if in7 or in8 then CHG_1=1; else CHG_1=0;
  if in9 or in10 then CHH_01=1; else CHH_01=0;
  if in11 or in12 then CHH_1=1; else CHH_1=0;
  if in13 or in14 then GC_01=1; else GC_01=0;
  if in15 or in16 then GC_1=1; else GC_1=0;

run;


proc freq data=gene_list noprint;
  tables CG_01*GC_01 / out=genes_CG_01_DMG_vs_DAG;
  tables CHG_01*GC_01 / out=genes_CHG_01_DMG_vs_DAG;
  tables CHH_01*GC_01 / out=genes_CHH_01_DMG_vs_DAG;
  tables CG_1*GC_1 / out=genes_CG_1_DMG_vs_DAG;
  tables CHG_1*GC_1 / out=genes_CHG_1_DMG_vs_DAG;
  tables CHH_1*GC_1 / out=genes_CHH_1_DMG_vs_DAG;
run;


proc print data=genes_CG_01_DMG_vs_DAG;
proc print data=genes_CHG_01_DMG_vs_DAG;
proc print data=genes_CHH_01_DMG_vs_DAG;
proc print data=genes_CG_1_DMG_vs_DAG;
proc print data=genes_CHG_1_DMG_vs_DAG;
proc print data=genes_CHH_1_DMG_vs_DAG;
run;


/*
genes_CG_01_DMG_vs_DAG

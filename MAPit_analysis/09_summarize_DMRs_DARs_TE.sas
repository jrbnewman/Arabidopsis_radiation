...
proc import datafile="/TB14/TB14/sandbox/dtra_sandbox/arabidopsis_radiation_transposable_element_HOMER.txt"
...
data wgbslocA.results_by_DMR_annot_TE;
...
data wgbslocA.results_by_DAR_annot_TE;
  set region_meth_binom_annot;
run;

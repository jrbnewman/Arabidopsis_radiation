...
by site_type chr start_pos stop_pos;
    weight count;
    exact fisher;
   tables condition * flag_methylated / chisq fisher  or ;
   output out=fet_dmc fisher chisq  or ;
    run;
...
weight count;
exact fisher;
   tables condition * unit * flag_methylated / cmh chisq or;
   output out=fet_dmc fisher chisq or  cmh;
    run;

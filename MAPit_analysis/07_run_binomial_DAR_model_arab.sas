...
data wgbslocA.bin_dar_pred_&chrom.;   set gmxout; run;
data wgbslocA.bin_dar_anova_&chrom.;   set anova; run;
data wgbslocA.bin_dar_contrasts_&chrom.;   set con; run;
data wgbslocA.bin_dar_estimates_&chrom.;   set est; run;
data wgbslocA.bin_dar_fitstats_&chrom.;   set fits; run;
data wgbslocA.bin_dar_odds_&chrom.;   set odds; run;

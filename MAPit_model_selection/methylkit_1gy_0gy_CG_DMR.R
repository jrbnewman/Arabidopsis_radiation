...
myBed = "/TB14/TB14/sandbox/dtra_sandbox/DMR_CG_100cGy.bed"
...
write.table(myDiff, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_0gy_1gy_CG.DMR.results.txt",
	                append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

write.table(myDiffOverDispers, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_0gy_1gy_CG.DMR.results.overdispersion.txt",
	                append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

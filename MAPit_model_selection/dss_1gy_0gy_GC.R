...
dat2.1A <- read.table("/TB14/TB14/sandbox/dtra_sandbox/at_rad_dss_1gy_0U_R1.txt", header=TRUE)
dat2.1B <- read.table("/TB14/TB14/sandbox/dtra_sandbox/at_rad_dss_1gy_100U_R1.txt", header=TRUE)
dat2.2A <- read.table("/TB14/TB14/sandbox/dtra_sandbox/at_rad_dss_1gy_0U_R2.txt", header=TRUE)
dat2.2B <- read.table("/TB14/TB14/sandbox/dtra_sandbox/at_rad_dss_1gy_100U_R2.txt", header=TRUE)
...
write.table(DMLtest.treatment, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_dss_0cGy_1cGy_GC.treatment.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

write.table(DMLtest.int, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_dss_0cGy_1cGy_GC.trt_by_units.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

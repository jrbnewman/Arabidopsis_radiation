...
write.table(binTest, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylsig_0cGy_1cGy_CG.binomial.DMR.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)
...
write.table(betaTest, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylsig_0cGy_1cGy_CG.betabinomial.DMR.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

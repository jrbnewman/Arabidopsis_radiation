...
myBed = "/TB14/TB14/sandbox/dtra_sandbox/DAR_GC_100cGy.bed"
...
write.table(myDiff, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_0cGy_1cGy_GC.DAR.results2.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

myDiffOverDispers <- calculateDiffMeth(meth, covariates=covariates, overdispersion="MN", test="Chisq", mc.cores=1)

write.table(myDiffOverDispers, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_0cGy_1cGy_GC.DAR.results2.overdispersion.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

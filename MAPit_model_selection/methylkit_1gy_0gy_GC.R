...
file.list=list("/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_0gy_0U_R1.txt",
	       ...
	       "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_1gy_0U_R1.txt",
	       "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_1gy_0U_R2.txt",
	       "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_1gy_100U_R1.txt",
	       "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_1gy_100U_R2.txt")
...
write.table(myDiff, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_0cGy_1cGy_GC.results.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

write.table(myDiffOverDispers, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylkit_0cGy_1cGy_GC.results.overdispersion.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

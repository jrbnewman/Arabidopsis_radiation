...
write.table(binTest, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylsig_0cGy_01cGy_CHH.binomial.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

write.table(betaTest, "/TB14/TB14/sandbox/dtra_sandbox/at_rad_methylsig_0cGy_01cGy_CHH.betabinomial.txt", append = FALSE, sep = "\t", dec = ".",   row.names = FALSE, col.names = TRUE)

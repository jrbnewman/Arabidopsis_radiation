...
data gc_data;
  ...
  where site_type="GC" and temperature = "FANS";
run;
...
proc means data=tss_pos_gc_all_2 noprint;
  by pos_abs grouped_pos;
  var FANS_0p5U FANS_1p5U FANS_25U FANS_5U;
...
proc means data=mean_diff_tss_all_1000 noprint;
  by grouped_pos;
  var mean_FANS_0p5U mean_FANS_1p5U mean_FANS_25U mean_FANS_5U;
...
proc export data=mean_diff_tss_all_1000_2
   outfile="!PATCON/arabidopsis_wgbs_cold/analysis_output/FANS_GC_accessibility_1kb_TSS_all_sites_nobin.csv"
   dbms=csv
   replace;
run;

proc export data=mean_diff_tss_10X_1000_2
   outfile="!PATCON/arabidopsis_wgbs_cold/analysis_output/FANS_GC_accessibility_1kb_TSS_10X_sites_nobin.csv"
   dbms=csv
   replace;
run;

proc export data=mean_diff_tss_all_100_2
   outfile="!PATCON/arabidopsis_wgbs_cold/analysis_output/FANS_GC_accessibility_1kb_TSS_all_sites_binned.csv"
   dbms=csv
   replace;
run;

proc export data=mean_diff_tss_10X_100_2
   outfile="!PATCON/arabidopsis_wgbs_cold/analysis_output/FANS_GC_accessibility_1kb_TSS_10X_sites_binned.csv"
   dbms=csv
   replace;
run;

...
PYSCRIPT=$PROJ/scripts/tss_accessibility_plots_FANS_03jrbn_zoom.py
...
for CONDIT in 22C_100U 22C_100U_0U 4C_100U_0U 22C_100U_0U_common 4C_100U_0U_common FANS_0p5U FANS_1p5U FANS_25U FANS_5U; do
    ...
    OUTPUT1=$PROJ/analysis_output/GC_accessibility_1kb_TSS_all_sites_nobin_transcript_TSS_${CONDIT}_20200212_zoomin.pdf
    ...
    OUTPUT2=$PROJ/analysis_output/GC_accessibility_1kb_TSS_10X_sites_nobin_transcript_TSS_${CONDIT}_20200212_zoomin.pdf
    ...
    OUTPUT3=$PROJ/analysis_output/GC_accessibility_1kb_TSS_all_sites_binned_transcript_TSS_${CONDIT}_20200212_zoomin.pdf
    ...
    OUTPUT4=$PROJ/analysis_output/GC_accessibility_1kb_TSS_10X_sites_binned_transcript_TSS_${CONDIT}_20200212_zoomin.pdf
    ...
    OUTPUT5=$PROJ/analysis_output/GC_accessibility_1kb_TSS_all_sites_nobin_HOMER_${CONDIT}_20200212_zoomin.pdf
    ...
    OUTPUT6=$PROJ/analysis_output/GC_accessibility_1kb_TSS_10X_sites_nobin_HOMER_${CONDIT}_20200212_zoomin.pdf
    ...
    OUTPUT7=$PROJ/analysis_output/GC_accessibility_1kb_TSS_all_sites_binned_HOMER_${CONDIT}_20200212_zoomin.pdf
    ...
    OUTPUT8=$PROJ/analysis_output/GC_accessibility_1kb_TSS_10X_sites_binned_HOMER_${CONDIT}_20200212_zoomin.pdf
